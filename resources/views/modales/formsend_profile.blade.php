    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12" id="step_two" style="display: none">
            <input type="tel" id="phone_number" class="form-control" placeholder="+{!!Session('phone')!!}" required="" style="text-align: center" disabled>
          </div>
