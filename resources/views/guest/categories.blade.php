                            ...
                            <div class="col-sm w w-auto-xs m-b">
                                <div class="item w rounded">
                                    <div class="item-media">
                                        <div class="item-media-content" style="background-image: url('{{asset('images/categories/'.$artist_details->photo_name)}}')"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm">
...
<div class="item-media">
                                        <a href="" class="item-media-content" style="background-image: url('{{asset('images/artists/'.$song_art->artist->photo_name)}}')"></a>
                                    </div>
                                                    <div class="item-info " >
