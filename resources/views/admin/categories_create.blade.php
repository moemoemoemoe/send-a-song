...
<div class="container">
	<div class="row">
		...
		<div class="col-md-9 ">
			  <div class="row">
                    <div class="col-md-9"><h3 class="text text-primary">Create category</h3></div>
...
<form method="POST" enctype="multipart/form-data" class="well">
	...
	<p>
		<input type="text" name="original_name" placeholder="Original name" class="form-control" value="{{old('original_name')}}">
	</p>
	<p>
		<input type="text" name="foreign_name" placeholder="Foreign name" class="form-control" value="{{old('foreign_name')}}">
	</p>
	<p>
		<textarea type="text" name="details" placeholder="Details" class="form-control" value="{{old('details')}}"></textarea>
	</p>
	<p>
		<b>
			Choose a photo
